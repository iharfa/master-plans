...
const DATA_VERSIONS = {
  "1.0":{ label:"V1.0", date:"8 Jul 2026",
    ...
    DOC_ALIGN:DOC_ALIGN_V10, MINDMAP:MINDMAP_V10, MM_PLAN:MM_PLAN_V10 },
  "1.2":{ label:"V1.2", date:"10 Aug 2026",
    ...
    DOC_ALIGN:DOC_ALIGN_V12, MINDMAP:MINDMAP_V12, MM_PLAN:MM_PLAN_V12 }
};
let DATA_VER, PLANS, GAPS, OVERLAPS, INTEGRITY, DOC_ALIGN, MINDMAP, MM_PLAN;
function applyDataVersion(v){
  const d = DATA_VERSIONS[v] || DATA_VERSIONS["1.2"];
  DATA_VER = DATA_VERSIONS[v] ? v : "1.2";
  ({PLANS,GAPS,OVERLAPS,INTEGRITY,DOC_ALIGN,MINDMAP,MM_PLAN} = d);
}
